...
function PageLogic(pageView, pageModel) {
    ...
    this.changeMenu = function (curId, targetId) {
        ...
        var menus = ["system-status", "internet-setting", "wireless-setting", "guest-setting", "parent-control", "ipv6-setting", "advance", "system", "other"],
            $cur = $('#' + curId),
            $target = $('#' + targetId),
...
$(function () {
    ...
    //APP功能
    !(/*OEM_CONFIG_HAS_APP|true*/false/* OEMTAG 是否支持APP管理*/) && $("#adv_cloud").remove();
});
...
staInfo = {
    ...
    showWorkMode: function (workMode, nodeType) {
        ...
        if (workMode == "ap" || workMode == "client+ap") {
            ...
            $("[href='#parent-control']").parent().addClass("none");
            hideArr = ["wrl_guest", "adv_netcontrol", "adv_firewall", "adv_ddns", "adv_virtualServer", "adv_dmz", "adv_iptv", "adv_route", "adv_upnp", "ip_mac_bind", "sys_wan", "adv_remoteweb"];
        ...
        if(nodeType === "agent") { //子节点信息
            ...
            hideArr = ["adv_netcontrol", "adv_iptv", "adv_macFilter", "adv_firewall", "adv_virtualServer", "adv_dmz", "adv_route", "adv_upnp", "adv_remoteweb"];
            hideArr.push("sys_lan_status", "sys_backup");
            //次节点下隐藏以下模块
            hideArr.push("wrl_ssid_pwd", "wrl_channel", "wrl_signal", "wrl_access", "wrl_guest", "wrl_wps", "wrl_ofdma", "wrl_ap_mode")
        }
        if(workMode == 'router'){
            hideArr.push('wrl_guest');
        }
        $("[href='#guest-setting']").parent().addClass("none");
        $("[href='#vpn-setting']").parent().addClass("none");
        hideArr.push("adv_sleepMode");
        //hideArr.push("adv_iptv");
...
wrlInfo = {
    ...
    getIframe: function () {
        ...
        switch (id) {
            ...
            case "wrl_wps":
                ...
                break;
            case "wrl_guest":
                showIframe("访客网络", "wifi_guest.html", 600, 400);
                break;
            ...
            case "wrl_ap_mode":
                ...
                break;
            case "wrl_meshSwitch":
                showIframe(_("MESH组网扩展"), "wifi_meshSwitch.html", 600, 300);
                break;
            case "wrl_anti_interference":
                showIframe(_("Anti-interference"), "anti_interference.html", 600, 300);
                break;
            // case "wrl_access":
            //     showIframe(_("无线访问控制"), "wireless_access2.html", 600, 300);
            //     break;
    ...
    setValue: function (obj) {
        ...
        if (obj.WebofdmaEn === "0") {
            $("#wrl_ofdma").addClass("disabled");
        } else {
          $("#wrl_ofdma").removeClass("disabled");
        }
        if (obj.apMode === "1") {
        ...
        if (obj.meshEn === "1") {
            $("#wrl_meshSwitch .function-status").html(_("Enable"));
        } else {
            $("#wrl_meshSwitch .function-status").html(_("Disable"));
        }
        if (obj.wispEn == 0) {
        ...
        // if (obj.wrlAccess === "black") {
        //     $("#wrl_access .function-status").html(_("Blacklist"));
        // } else if (obj.wrlAccess === "white"){
        //     $("#wrl_access .function-status").html(_("Whitelist"));
        // } else {
        //     $("#wrl_access .function-status").html(_(""));
        // }
    ...
    init: function () {
        if (!parentInfo.loading) {
            ...
            $("#parental_list").on("click", ".edit-new", function () {
                ...
                $("#head_title").html(_("URL过滤")).addClass("selected");
                showIframe(_("URL过滤"), "parental_control.html", 700, 200);
...
advInfo = {
    ...
    setValue: function (obj) {
        ...
        if (obj.firewall === "high") {
            $("#adv_firewall .function-status").html(_("高"));
        } else if (obj.firewall === "middle"){
            $("#adv_firewall .function-status").html(_("中"));
        } else {
            $("#adv_firewall .function-status").html(_("低"));
        }
        ...
        if (obj.andlinkEn === "0") {
            $("#wrl_and_link .function-status").html(_("关闭"));
        } else {
            $("#wrl_and_link .function-status").html(_("开启"));
        }

        if (obj.greenNetEn === "0") {
            $("#green_internet .function-status").html(_("关闭"));
        } else {
            $("#green_internet .function-status").html(_("开启"));
        }
    },
    getIframe: function () {
        if ($(this).hasClass("disabled")) return;
        var filterStr = _("Filter MAC Address");
        var id = $(this).attr("id");
        switch (id) {
            case "adv_sleepMode":
            ...
            case "adv_virtualServer":
                showIframe(_("DMZ端口"), "virtual_server.html", 700, 550);
                break;
            case "adv_macFilter":

                showIframe(filterStr, "mac_filter.html", 700, 550);
                break;
            case "adv_dmz":
            ...
            case "adv_iptv":
                if(window.CONFIG_TENDA_IMAGE_HEAD == "AX1806_V2" || window.CONFIG_TENDA_IMAGE_HEAD == "AX1803_V2") {
                    showIframe(_("IPTV"), "iptv_v2.html", 580, 510);
                } else {
            ...
            case "adv_firewall":
                ...
                break;
            case "wrl_and_link":
                showIframe(_("AndLink"), "andlink.html", 600, 300);
                break;
            case "green_internet":
                showIframe(_("Green Internet access"), "greenInternet.html", 600, 300);
                break;
        }
        G.iframeFlag = true;
    }
    ...
    getIframe: function () {
        ...
        switch (id) {
            case "sys_status":
                ...
                break;
            case "sys_pwd":
                showIframe("管理员账号", "system_password.html", 500, 310);
                break;
            case "sys_lan_status":
...
var goExit = '<span class="go-exit" style="float: left"><a style=" color: #999;" href="goform/exit">Exit</a><span class="app-qr">Hejiahuan App</span></span>';
...
if (B.lang == "zh" || B.lang == "cn") {
    $(".go-exit").css('width', '200px');
}
$('.app-qr').on('click', function () {
    $('.app-dailog').removeClass('none');
})
