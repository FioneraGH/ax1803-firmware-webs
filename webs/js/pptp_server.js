	...
	G.validate = $.validate({
		custom: function () {
			var i = 0,
				...
				pptpSvrMask = G.data.pptpSvrMask,
			...
			if ($("#serverEn").val() == "1") {
				if (lanIp != "" && checkIpInSameSegment(startIp, pptpSvrMask, lanIp, lanMask)) {
				...
				if (vlan2Ip != "" && checkIpInSameSegment(startIp, pptpSvrMask, vlan2Ip, vlan2Mask)) {
